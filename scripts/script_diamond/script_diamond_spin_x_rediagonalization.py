...
print(v[:, index_of_state].conj().dot(v[:, index_of_state-1]))
...
#ax.set_yticks([])
#import os
#plt.savefig(os.path.join("plots/spin", "sigma_x_component_n1_"+str(n1)+"_n2_"+str(n2)+".png"))
...
from lattice_utils import Hamiltonian_generator, I_J_conv, atom_positions_generator, Hamiltonian_boundaries_generator, Circle_label_generator
...
Labels = Circle_label_generator(v1, v2, n1, n2, r)
H = Hamiltonian_boundaries_generator(n1, n2, t, t_so, b_0, Labels)[0]
u, v = eigh(H)
...
for i in range(xs.shape[0]):
    ...
    if Labels[tuple(indeces_labels[int((i - i%2)/2)])] == 1:
...
ax.set_yticks([])
#plt.colorbar()
plt.savefig("plot_energy_plu_density_BOUNDARIES.png")